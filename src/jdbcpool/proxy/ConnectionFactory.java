...
{ 
	 ...
	 static Hashtable<String, DataSourceImpl> connectionPools = null; 
	 static{ 
		 connectionPools = new Hashtable<String, DataSourceImpl>(2,0.75F); 
	 } 
	 /** 
	 ...
	 */ 
	 ...
	 { 
		 Object ds = connectionPools.get(dataSource); 
