...
public class MyListTestIterator<E> extends AbstractList<E> implements List<E>,
		RandomAccess, Cloneable, java.io.Serializable {

	private static final long serialVersionUID = 8683452581122892189L;

	/**
	 * The array buffer into which the elements of the MyListTestIterator are
	 * stored. The capacity of the MyListTestIterator is the length of this
	 * array buffer.
	 */
	private transient Object[] elementData;

	/**
	 * The size of the MyListTestIterator (the number of elements it contains).
	 * 
	 * @serial
	 */
	private int size;
	 ...
	 */
	public MyListTestIterator(int initialCapacity) {
		super();
	 ...
	 */
	public MyListTestIterator(Collection<? extends E> c) {
	...
	/**
	 * Trims the capacity of this <tt>MyListTestIterator</tt> instance to be the
	 * list's current size. An application can use this operation to minimize
	 * the storage of an <tt>MyListTestIterator</tt> instance.
	 */
	...
	/**
	 * Increases the capacity of this <tt>MyListTestIterator</tt> instance, if
	...
	/**
	 * Returns a shallow copy of this <tt>MyListTestIterator</tt> instance. (The
	 * elements themselves are not copied.)
	 * 
	 * @return a clone of this <tt>MyListTestIterator</tt> instance
	 */
	@Override
	public Object clone() {
		try {
			@SuppressWarnings("unchecked")
			MyListTestIterator<E> v = (MyListTestIterator<E>) super.clone();
	...
	/**
	 * Save the state of the <tt>MyListTestIterator</tt> instance to a stream
	 * (that is, serialize it).
	 * 
	 * @serialData The length of the array backing the
	 *             <tt>MyListTestIterator</tt> instance is emitted (int),
	 *             followed by all of its elements (each an <tt>Object</tt>) in
	 *             the proper order.
	 */
	...
	/**
	 * Reconstitute the <tt>MyListTestIterator</tt> instance from a stream (that
	 * is, deserialize it).
	 */
	...
	private class Itr implements Iterator<E> {
		...
		public E next() {
			...
			Object[] elementData = MyListTestIterator.this.elementData;
		...
		public void remove() {
			...
			try {
				MyListTestIterator.this.remove(lastRet);
				cursor = lastRet;
				lastRet = -1;
	...
	private class ListItr extends Itr implements ListIterator<E> {
		...
		public void set(E e) {
			...
			try {
				MyListTestIterator.this.set(lastRet, e);
			} catch (IndexOutOfBoundsException ex) {
				throw new ConcurrentModificationException();
			}
		}
		...
		public void add(E e) {
			...
			try {
				int i = cursor;
				MyListTestIterator.this.add(i, e);
				cursor = i + 1;
				lastRet = -1;
				expectedModCount = modCount;
			} catch (IndexOutOfBoundsException ex) {
